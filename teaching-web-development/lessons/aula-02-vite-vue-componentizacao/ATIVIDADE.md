...
1. Quais responsabilidades foram separadas?o cabeçalho, o conteúdo/card principal e o rodapé foram separados em componentes independentes.
2. Que arquivos podem ser compreendidos isoladamente?AppHeader.vue, ProjectCard.vue e AppFooter.vue, porque cada um representa uma parte específica da interface.
3. Em que situação criar componentes demais também poderia atrapalhar?Se dividirmos uma interface em componentes muito pequenos e desnecessários, o projeto pode ficar mais difícil de entender e manter, com muitos arquivos e componentes sem uma responsabilidade realmente útil.
...
1. Qual ferramenta é o framework e qual organiza o ambiente de desenvolvimento?o framework é o Vue e o ambiente é organizado pelo Vite.
2. Por que `AppHeader.vue` é um componente, e não apenas “mais um arquivo”?porque ele encapsula uma parte isolada da interface com sua própria estrutura e estilo.
3. Qual evidência mostra que o protótipo foi realmente componentizado?o App.vue agora importa e usa as tags filhas como <AppHeader/>, e o visual é dividido em arquivos .vue separados.
4. Qual rota a dupla utilizou e qual limitação ela possui?se usaram a Rota A com o npm, a vantagem é o HMR e recompilação automática.
