      ...
      <ScrollView contentContainerStyle={styles.conteudo}>
        ...
        <View style={styles.controles}>
          <Pressable
            ...
            accessibilityLabel={somenteAtencao ? "Mostrar todos os indicadores" : "Filtrar apenas indicadores em atenção"}
          ...
          <View style={styles.contagemBox}>
            <Text style={styles.contagem} accessibilityLabel={`${indicadoresVisiveis.length} indicadores exibidos`}>
